...
public class DBLinkPollForAdd {
	...
	private DBLinkPollForAdd(){
		
	}
	
	public static void setFileName(String fileName) {
		DBLinkPollForAdd.fileName = fileName;
	}
...
//			dbcpDataSource.setDriverClassName(driver);
			...
			dbcpDataSource.setPassword("qazwsx123456");
			dbcpDataSource.setUrl("jdbc:mysql://120.25.160.211:15000/platformbackstage?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull");
			...
			DBLinkPollForAdd.ds = dbcpDataSource;
	...
	public static void main(String[] args) throws SQLException {
		QueryRunner qr = DBLinkPollForAdd.getQueryRunner();
